...
class EventoAgendaForm(forms.ModelForm):
    class Meta:
        ...
        fields = [
            ...
            'anticipacion_dias', 'recurrencia', 'destinatarios', 'activo',
            'cliente', 'direccion', 'lat', 'lng',
        ]
        widgets = {
            'titulo': forms.TextInput(attrs={'class': _INPUT, 'placeholder': 'Ej: Visita a obra de Pérez'}),
            ...
            'recurrencia': forms.Select(attrs={'class': _INPUT}),
    ...
    def __init__(self, *args, **kwargs):
        ...
        # Mostrar la hora ya guardada en el input type=time
