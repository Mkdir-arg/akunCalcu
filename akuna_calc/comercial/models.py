...
class Venta(models.Model):
    ...
    venta_en_dolares = models.BooleanField(default=False, verbose_name='Venta en dólares')
    valor_total_usd = models.DecimalField(max_digits=12, decimal_places=2, null=True, blank=True, verbose_name='Valor total en USD')
    ...
    sena_en_dolares = models.BooleanField(default=False, verbose_name='Seña en dólares')
    sena_usd = models.DecimalField(max_digits=12, decimal_places=2, null=True, blank=True, verbose_name='Seña en USD')
    cotizacion_sena_usd = models.DecimalField(max_digits=10, decimal_places=2, null=True, blank=True, verbose_name='Cotización USD de la seña')
...
class Compra(models.Model):
    ...
    valor_total = models.DecimalField(max_digits=12, decimal_places=2, validators=[MinValueValidator(Decimal('0.01'))])
    compra_en_dolares = models.BooleanField(default=False, verbose_name='Compra en dólares')
    valor_total_usd = models.DecimalField(max_digits=12, decimal_places=2, null=True, blank=True, verbose_name='Valor total en USD')
    cotizacion_usd = models.DecimalField(max_digits=10, decimal_places=2, null=True, blank=True, verbose_name='Cotización USD utilizada')
    sena = models.DecimalField(max_digits=12, decimal_places=2, default=0)
    sena_en_dolares = models.BooleanField(default=False, verbose_name='Seña en dólares')
