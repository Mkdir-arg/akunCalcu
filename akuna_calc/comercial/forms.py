...
class VentaForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            ...
            'monto_cobrado': forms.NumberInput(attrs={'class': 'w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500', 'step': '0.01'}),
