...
from .config_views import (
    ...
    producto_create, producto_edit, producto_delete, producto_activate, productos_estado_masivo,
...
urlpatterns = [
    ...
    path("config/productos/<int:pk>/activar/", producto_activate, name="config-producto-activate"),
    path("config/productos/estado-masivo/", productos_estado_masivo, name="config-productos-estado-masivo"),
