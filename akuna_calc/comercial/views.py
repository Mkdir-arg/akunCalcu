...
def duplicar_venta(request, pk):
    ...
    nueva = Venta.objects.create(
        ...
        venta_en_dolares=original.venta_en_dolares,
        valor_total_usd=original.valor_total_usd,
        cotizacion_usd=original.cotizacion_usd,
        sena=original.sena,
        sena_en_dolares=original.sena_en_dolares,
        sena_usd=original.sena_usd,
        cotizacion_sena_usd=original.cotizacion_sena_usd,
        ...
        if form.is_valid():
            ...
            total_usd = sum(
                (
                    ...
                    if item['pago_en_dolares'] and item['monto_usd']
                ),
                Decimal('0'),
            )
